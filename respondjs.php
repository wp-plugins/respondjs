...
Description: Respond.js is a fast & lightweight polyfill for min/max-width CSS3 Media Queries (for IE 6-8, and more).
Version: 1.0.0
Author: Ramoonus
Author URI: http://www.ramoonus.nl/wordpress/respondjs/
*/
